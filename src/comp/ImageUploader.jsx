...
function ImageUploader() {
  ...
  const handleGenerateBook = () => {
    ...
    Continuing along the river, the group saw a Lilensternus, which seemed unusually calm, unaware of the approaching Postosuchus. The hunting moment was swift and thrilling, leaving all the tourists in awe.
    ...
    In front of them appeared a group of Brontosaurs, peacefully grazing among the trees. "And these giants," continued Roxy, "could easily peek into the second-floor window of your house without standing on tiptoes. And despite their huge size, their brains were the size of a nut. Who knows, maybe they just didn't want to bother with complex tasks!"
    
    Continuing on their way, ${name}'s attention was drawn to a herd of Stegosaurus engaged in mating rituals. The male Stegosauruses impressively competed with each other, clashing their massive bodies and spiked tails. "Stegosaurs, in addition to their famous plates and tail spikes, used them to regulate body temperature and, of course, for protection. During the mating season, they became real knights in armour, fighting for the attention of females," Roxy explained, adding a historical fact to the captivating spectacle.
    ...
    ${name} was amazed by the information and couldn't stop marvelling at how complex and diverse the ancient world was.
    ...
    After an exciting day full of discoveries and adventures, ${name} and the other tourists arrived at the final base of their tour. It was the last stop before returning to the modern world. Before taking off her watch, Roxy added one last fun fact: "You know, if dinosaurs had used social media, their least favourite emoji would probably have been the asteroid!" This joke made ${name} laugh, though he felt a tinge of sadness at parting with Roxy.
    
    "Thank you, Roxy, for all these stories and adventures. It was fun and very interesting!" ${name} thanked her, bidding farewell to the artificial intelligence. He took off the watch, sat in his probe, and soon they all returned to their own time.
    ...
    const pages = splitTextIntoPages(originalBookText, 9);
    setBookText(pages);
  };
